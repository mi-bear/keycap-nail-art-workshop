...
| <nobr>ベースコート</nobr> | <nobr>下地</nobr>       | ジェルネイル用下地。<br><img src="./images/001.jpg" width="50%">           |
| <nobr>トップコート</nobr> | <nobr>仕上げ</nobr>      | ツヤ出し＆保護用。<br><img src="./images/002.jpg" width="50%">            |
| <nobr>カラージェル</nobr> | <nobr>デザイン用</nobr>    | 好きな色を選んで OK！<br><img src="./images/006.jpg" width="50%">         |
| <nobr>ネイルシールやパーツなど</nobr> | <nobr>デコレーション用</nobr> | 小さくてかわいいパーツが揃っています。<br><img src="./images/011.jpg" width="50%">  |
| <nobr>LEDライト</nobr> | <nobr>硬化用</nobr>      | ネイル用ミニ LED。<br><img src="./images/004.jpg" width="50%">          |
